...
export const en = {
	...
	sync: {
		title: "Sync",
		description: "Sync your data across devices on the same network",
		heading: "Local Sync",
		subheading:
			"Pair devices on the same WiFi network to sync your data — no cloud required",
		thisDevice: "This Device",
		trustedDevices: "Trusted Devices",
		noTrustedDevices: "No trusted devices",
		noTrustedDevicesDescription: "Pair with another device to start syncing",
		nearbyDevices: "Nearby Devices",
		scanningForDevices: "Scanning for devices...",
		noNearbyDevices: "No Finance Tracker devices found nearby",
		startScanning: "Scan for Devices",
		...
		confirmPairingDescription:
			"Make sure the code below matches on both devices",
		verificationCode: "Verification Code",
		verificationCodeDescription:
			"Compare this code with the other device. If they match, confirm the pairing.",
		confirm: "Codes Match — Confirm",
		reject: "Codes Don't Match — Reject",
		...
		connectToDeviceDescription: "Enter any Finance Tracker device's local IP to pair",
		hostSyncSession: "Host Sync Session",
		hostSyncDescription: "Let other devices connect and sync with you over WiFi",
		yourIpAddress: "Your IP Address",
		startHosting: "Start Hosting",
		stopHosting: "Stop Hosting",
		hosting: "Hosting — waiting for connections...",
		syncEnterIp: "Enter IP to Sync",
		syncEnterIpDescription: "Enter the device's local IP address to start syncing",
		toast: {
