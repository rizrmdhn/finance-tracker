...
export const id = {
	...
	sync: {
		title: "Sinkronisasi",
		description: "Sinkronkan data Anda antar perangkat di jaringan yang sama",
		heading: "Sinkronisasi Lokal",
		subheading:
			"Pasangkan perangkat di jaringan WiFi yang sama untuk menyinkronkan data — tanpa cloud",
		thisDevice: "Perangkat Ini",
		trustedDevices: "Perangkat Terpercaya",
		noTrustedDevices: "Tidak ada perangkat terpercaya",
		noTrustedDevicesDescription:
			"Pasangkan dengan perangkat lain untuk mulai sinkronisasi",
		nearbyDevices: "Perangkat Terdekat",
		scanningForDevices: "Mencari perangkat...",
		noNearbyDevices: "Tidak ada perangkat Finance Tracker di sekitar",
		startScanning: "Cari Perangkat",
		stopScanning: "Berhenti Mencari",
		pair: "Pasangkan",
		...
		never: "Tidak pernah",
		pairedOn: "Dipasangkan pada",
		confirmPairing: "Konfirmasi Pemasangan",
		confirmPairingDescription:
			"Pastikan kode di bawah ini cocok di kedua perangkat",
		verificationCode: "Kode Verifikasi",
		verificationCodeDescription:
			"Bandingkan kode ini dengan perangkat lain. Jika cocok, konfirmasi pemasangan.",
		confirm: "Kode Cocok — Konfirmasi",
		reject: "Kode Tidak Cocok — Tolak",
		pairingInProgress: "Pemasangan sedang berlangsung...",
		...
		connectToDevice: "Hubungkan ke Perangkat",
		connectToDeviceDescription: "Masukkan IP lokal perangkat Finance Tracker untuk dipasangkan",
		hostSyncSession: "Jadi Host Sinkronisasi",
		hostSyncDescription: "Biarkan perangkat lain terhubung dan menyinkronkan data dengan Anda melalui WiFi",
		yourIpAddress: "Alamat IP Anda",
		startHosting: "Mulai Hosting",
		stopHosting: "Hentikan Hosting",
		hosting: "Hosting — menunggu koneksi...",
		syncEnterIp: "Masukkan IP untuk Sinkronisasi",
		syncEnterIpDescription: "Masukkan alamat IP lokal perangkat untuk mulai sinkronisasi",
		toast: {
