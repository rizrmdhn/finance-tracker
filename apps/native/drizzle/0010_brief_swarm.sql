...
INSERT INTO `__new_accounts`("id", "name", "icon", "color", "type", "initial_balance", "currency", "created_at", "updated_at", "deleted_at") SELECT "id", "name", "icon", "color", "type", "initial_balance", "currency", "created_at", "updated_at", "deleted_at" FROM `accounts`;--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `__new_app_settings`("key", "value") SELECT "key", "value" FROM `app_settings`;--> statement-breakpoint
