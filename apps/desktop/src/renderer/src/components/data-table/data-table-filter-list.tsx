...
import { dataTableConfig } from "@finance-tracker/types";
...
import {
	...
	FacetedList,
	FacetedTrigger,
} from "@finance-tracker/ui/components/faceted";
...
import {
	...
	SortableItemHandle,
	SortableOverlay,
} from "@finance-tracker/ui/components/sortable";
				...
				>
					...
					{filters.length > 0 ? (
						<SortableContent asChild>
							<ol className="flex max-h-75 flex-col gap-2 overflow-y-auto p-1">
		...
		case "boolean": {
			...
			return (
				<Select
					...
					value={filter.value}
					onValueChange={(value) => {
						if (value !== null) onFilterUpdate(filter.filterId, { value });
					}}
				>
					<SelectTrigger
						id={inputId}
